return {
  ...
  dependencies = {
    ...
    "zbirenbaum/copilot.lua", -- Modern Lua-based Copilot
  },
  config = function()
    ...
    local function get_selected_or_entire_file(context)
      ...
      if not is_visual_selection then
        ...
        vim.notify("No selection detected, using entire file: " .. #text .. " chars", vim.log.levels.INFO)
        return text
      end
      ...
      if not text or text == "" then
        ...
        vim.notify("Empty selection, falling back to entire file: " .. #text .. " chars", vim.log.levels.INFO)
      end
      ...
      prompt_library = {
        ["Explain Code"] = {
          ...
          prompts = {
            {
              role = "system",
              content = "You are an expert code analyzer. Provide detailed explanations of code, including purpose, functionality, and important concepts or techniques used.",
            },
            -- For "Explain Code" prompt
            {
              ...
              content = function(context)
                ...
                return "Explain the following code in detail, including its purpose, functionality, and any important concepts or techniques used:\n\n```"
                  .. context.filetype
                  .. "\n"
                  .. text
                  .. "\n```"
        ...
        ["Fix Issues"] = {
          ...
          prompts = {
            ...
            },
            {
              ...
              content = function(context)
                local text = get_selected_or_entire_file(context)
                return "Identify and fix issues in the following code. Provide the improved version with explanations of what was changed and why:\n\n```"
                  .. context.filetype
                  .. "\n"
                  .. text
                  .. "\n```"
        ...
        ["Fix Test Failures"] = {
          ...
          prompts = {
            ...
            },
            {
              ...
              content = function(context)
                local text = get_selected_or_entire_file(context)
                return "The following code has failing tests. Analyze the code and test failures, then provide a fixed implementation that will pass the tests:\n\nCode:\n```"
                  .. context.filetype
                  .. "\n"
                  .. text
        ...
        ["Scaffold Code"] = {
          ...
          prompts = {
            ...
            {
              role = "user",
              content = "Generate scaffolding code for the following requirement:",
              opts = {
                contains_code = false,
              },
            },
        ...
        ["Find Code"] = {
          ...
          prompts = {
            {
              role = "system",
              content = "You are an expert in analyzing codebases and finding relevant sections based on requirements or questions.",
            },
            {
              role = "user",
              content = "Find code in the current workspace that is relevant to the following question or requirement:",
              opts = {
                contains_code = false,
              },
            },
